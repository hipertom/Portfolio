          ...
          <div class="media">
            ...
            <div class="media-body">
              <div class="personal_text">
                ...
                <p>You will begin to realise why this exercise is called the Dickens Pattern (with reference to the
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 brand manipul creative">
          <div class="h_gallery_item">
            <div class="g_img_item">
              ...
              <a class="light" href="img/gallery/project-2.jpg"><img src="@/assets/img/gallery/icon.png" alt=""></a>
            </div>
            <div class="g_item_text">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 manipul creative design print">
          <div class="h_gallery_item">
            <div class="g_img_item">
              ...
              <a class="light" href="img/gallery/project-3.jpg"><img src="@/assets/img/gallery/icon.png" alt=""></a>
            </div>
            <div class="g_item_text">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 brand creative print">
          <div class="h_gallery_item">
            <div class="g_img_item">
              ...
              <a class="light" href="img/gallery/project-4.jpg"><img src="@/assets/img/gallery/icon.png" alt=""></a>
            </div>
            <div class="g_item_text">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 brand manipul design">
          <div class="h_gallery_item">
            <div class="g_img_item">
              ...
              <a class="light" href="img/gallery/project-5.jpg"><img src="@/assets/img/gallery/icon.png" alt=""></a>
            </div>
            <div class="g_item_text">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 brand creative">
          <div class="h_gallery_item">
            <div class="g_img_item">
              ...
              <a class="light" href="img/gallery/project-6.jpg"><img src="@/assets/img/gallery/icon.png" alt=""></a>
            </div>
            <div class="g_item_text">
